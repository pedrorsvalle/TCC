...
/* Arquivo que imprime certificado em imágem 
 * usa biblioteca gd com funções gráficas 
 * Para cada clique do mouse, tem as coordenadas 
 * que serão marcadas no certificado para a emição 
 * do certificado pelo sistema. Escolhe tambem o 
 * tamanho da fonte
 * São vários campos para posicionar com valor de x e y
 * e tamanho de fonte 
 * Monta a imagem jpg 
 */
...
// tratamento de campo vazio com campo com 0 de tamanho de fonte
...
if ( $_POST['texto'] == 'nome' ) $nome_ck = "checked";
if ( $_POST['texto'] == 'data' ) $data_ck = "checked";
if ( $_POST['texto'] == 'curso' ) $curso_ck = "checked";
if ( $_POST['texto'] == 'palestra' ) $palestra_ck = "checked";
if ( $_POST['texto'] == 'palestrante' ) $palestrante_ck = "checked";
if ( $_POST['texto'] == 'instituicao' ) $instituicao_ck = "checked";
